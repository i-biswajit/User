package com.cab.user.taxi.singledateandtimepicker.widget;
...
import static com.cab.user.taxi.singledateandtimepicker.DateHelper.getHour;
import static com.cab.user.taxi.singledateandtimepicker.DateHelper.today;
import static com.cab.user.taxi.singledateandtimepicker.widget.SingleDateAndTimeConstants.*;
import static com.cab.user.taxi.singledateandtimepicker.widget.SingleDateAndTimeConstants.MAX_HOUR_DEFAULT;
import static com.cab.user.taxi.singledateandtimepicker.widget.SingleDateAndTimeConstants.MIN_HOUR_DEFAULT;
