package com.cab.user.taxi.sidebar.payment
...
import com.cab.user.common.helper.Constants.INTENT_PAY_FOR
...
import com.cab.user.common.utils.CommonKeys.PAY_FOR_WALLET
...
import com.cab.user.common.utils.Enums.REQ_ADD_WALLET
...
class AddWalletActivity : CommonActivity(), ServiceListener, PaymentMethodNonceCreatedListener {
